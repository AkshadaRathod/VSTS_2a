...
class AnimationLeftPanel(wx.Panel):
    ...
    def __init__(self, parent, user_data):
        ...
        super(AnimationLeftPanel, self).__init__(parent, style=wx.BORDER_DOUBLE)
    ...
    def InitSignalUI(self):
        ...
        self.btnFaceImages = ['Lx_Icons/Boy_Face.png','Lx_Icons/Girl_Face.png','Lx_Icons/Men_Face.png','Lx_Icons/Women_Face.png']
        self.btnFaceInverted = ['Lx_Icons/Boy_Face_Inverted.png', 'Lx_Icons/Girl_Face_Inverted.png', 'Lx_Icons/Men_Face_Inverted.png',
    ...
    def OnClicked(self, e):
        ...
        self.ani = animation.FuncAnimation(self.figure_animation, self.animate, init_func=self.init, interval=0.1,
                                           frames=len(self.mat_px), repeat=False, blit=True)
    ...
    def init(self):  # only required for blitting to give a clean slate.
        ...
        if not self.Test_flip_click:
            ...
            jaw_area_fill = self.axes_animation.fill_between(-self.x + 425, self.y, 0, facecolor=[(254 / 255, 157 / 255, 111 / 255)])
    ...
    def animate(self, i):
        ...
        if self.Test_flip_click == False:
            ...
            poa = self.axes_animation.scatter(-self.h2_POA_pos[i] + 425, self.K2_POA_pos[i], color='red', s=150)
            jaw_area_fill = self.axes_animation.fill_between(-x + 425, y, 0, facecolor=[(254 / 255, 157 / 255, 111 / 255)])
